...
- Manual gate tool selection, gate creation, direct SVG handle editing/nudging, gate hierarchy, boolean-gate scaffold, backgating/live-linking messaging, and live statistics.
